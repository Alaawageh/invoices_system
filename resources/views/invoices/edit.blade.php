                                    ...
                                    <div class="row">
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="invoice_number" id="invoice_number" class="form-control" title="يرجي ادخال رقم الفاتورة" value="{{$invoices->invoice_number}}">
                                            </div>
                                        </div>
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                <label>تاريخ الفاتورة </label>
                                                <input type="date" name="invoice_date" id="invoice_date" class="form-control" value="{{$invoices->invoice_date}}">
                                            </div>
                                        </div>
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                <label>تاريخ الاستحقاق </label>
                                                <input type="date" name="due_date" id="due_date" class="form-control" value="{{$invoices->due_date}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
