								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
												<a href="/MarkAsRead"> تعيين قراءة الكل</a> </span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notifications_count">عدد الاشعارات :
									...
									<div id="unreadNotifications">
										...
										<div class="main-notification-list Notification-scroll" id="unreadNotifications">
											...
											<a class="d-flex p-3 border-bottom" href="{{'invoicesDetails'}}/{{$notification->data['invoice_id']}}">
